...
class Command(AdminCommand):
    ...
    def handle(self, *args, **options):
        ...
        """
        ignorable_type = options.get('ignored_type', settings.DEFAULT_DATABASE_TYPE)
        if ignorable_type == settings.DATABASE_TYPE:
            self.success('Not attempting connection due to DATABASE_TYPE')
            return
